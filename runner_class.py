...
pause_button = Button('pause_button.png', (50, 50))
play_button = Button('play_button.png', (50, 50))
button_group = pygame.sprite.Group()
button_group.add(pause_button, play_button)
    ...
    for event in pygame.event.get():
        ...
        if game_active:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                elif play_button.is_clicked(pygame.mouse.get_pos()):
                    game_active = True
